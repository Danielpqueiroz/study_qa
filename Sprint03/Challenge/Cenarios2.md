...
| **CT 04**     | Cadastrar um usuário com um e-mail de provedor proibido.(Gmail e Hotmail) | Foi permitido o cadastro dos provedores proibidos. | “message”: “Cadastro realizado com sucesso”. status 201 Created | ❌ | Deve ser corrigido para bloquear e-mails proibidos |
...
| Caso de Teste | Descrição | Resultado | Response | Status | Observações |
|---------------|-----------|-----------|----------|--------|-------------|
| **CT 23**     | Usuários não autenticados não devem conseguir realizar ações na rota de Produtos POST. | Produto cadastrado com sucesso. | “message”: “Produto cadastrado com sucesso”. status 201 Created | ✅ | - |
| **CT 24**     | Cadastrar um produto com todos os campos preenchidos corretamente. | Produto cadastrado com sucesso. | “message”: “Produto cadastrado com sucesso”. status 201 Created | ✅ | - |
| **CT 25**     | Cadastrar um produto sem preencher algum dos campos obrigatórios. | Falha no cadastro do produto. | “message”: “Campos obrigatórios não preenchidos”. status 400 Bad Request | ✅ | - |
| **CT 26**     | Cadastrar um produto com um nome que já está registrado. | Falha no cadastro do produto. | “message”: “Nome do produto já utilizado”. status 400 Bad Request | ✅ | - |
| **CT 27**     | Cadastrar um produto com um nome inválido. | Falha no cadastro do produto. | “message”: “Nome do produto inválido”. status 400 Bad Request | ✅ | - |

# Cenário de Leitura de Produtos (GET)

| Caso de Teste | Descrição | Resultado | Response | Status | Observações |
|---------------|-----------|-----------|----------|--------|-------------|
| **CT 28**     | Usuários não autenticados não devem conseguir realizar ações na rota de Produtos GET. | Produto cadastrado com sucesso. | “message”: “Produto cadastrado com sucesso”. status 201 Created | ✅ | - |
| **CT 29**     | Listar todos os produtos. | Produtos listados com sucesso. | “produtos”: [lista dos produtos]. status 200 OK | ✅ | - |
| **CT 30**     | Acessar um produto específico pelo ID. | Produto acessado com sucesso. | cadastro do produto. status 200 OK | ✅ | - |
| **CT 31**     | Acessar um produto com um ID inexistente. | Produto não encontrado. | “message”: “Produto não encontrado”. status 400 Bad Request | ✅ | - |

# Cenário de Atualização de Produtos (PUT)

| Caso de Teste | Descrição | Resultado | Response | Status | Observações |
|---------------|-----------|-----------|----------|--------|-------------|
| **CT 32**     | Usuários não autenticados não devem conseguir realizar ações na rota de Produtos PUT. | Produto cadastrado com sucesso. | “message”: “Produto cadastrado com sucesso”. status 201 Created | ✅ | - |
| **CT 33**     | Atualizar um produto existente com dados válidos. | Produto atualizado com sucesso. | “message”: “Produto atualizado com sucesso”. status 200 OK | ✅ | - |
| **CT 34**     | Atualizar um produto com um nome já utilizado por outro produto. | Falha na atualização do produto. | “message”: “Nome do produto já utilizado”. status 400 Bad Request | ✅ | - |
| **CT 35**     | Atualizar um produto com um ID inexistente (deve criar um novo produto). | Produto criado com sucesso. | “message”: “Produto criado com sucesso”. status 201 Created | ✅ | - |
| **CT 36**     | Atualizar um produto com um nome inválido. | Falha na atualização do produto. | “message”: “Nome do produto inválido”. status 400 Bad Request | ✅ | - |
| **CT 37**     | Produtos criados através do PUT não poderão ter nomes previamente cadastrados.| Falha na atualização do produto. | “message”: “Nome do produto inválido”. status 400 Bad Request | ✅ | - |

# Cenário de Exclusão de Produtos (DELETE)

| Caso de Teste | Descrição | Resultado | Response | Status | Observações |
|---------------|-----------|-----------|----------|--------|-------------|
| **CT 38**     | Usuários não autenticados não devem conseguir realizar ações na rota de Produtos DELETE. | Produto cadastrado com sucesso. | “message”: “Produto cadastrado com sucesso”. status 201 Created | ✅ | - |
| **CT 39**     | Não deve ser possível excluir produtos que estão dentro de carrinhos | Produto excluído com sucesso. | “message”: “Produto excluído com sucesso”. status 200 OK | ✅ | - |
| **CT 40**     | Excluir um produto existente. | Produto excluído com sucesso. | “message”: “Produto excluído com sucesso”. status 200 OK | ✅ | - |
| **CT 41**     | Excluir um produto com um ID inexistente. | Falha na exclusão do produto. | “message”: “Nenhum produto encontrado”. status 400 Bad Request | ✅ | - |
